...
class AppConfiguration private constructor() {
    ...
    fun setMobileConfiguration(context: Context, mobile: Mobile?) {
     ...
     fun setManualCheckIn(context: Context, isManualCheckIn: Boolean?) {
        DataStore.saveBooleanData(context, DataStore.IS_MANUAL_CHECK_IN_ON, isManualCheckIn!!)
     }
    ...
    fun setTimerManualCheckInEnable(context: Context,isEnable: Boolean) {
     ...
     private fun setCheckInTimeOut(context: Context, checkInTimeOut: Int?) {
    ...
    fun setTimeBetweenCheckinLng(context: Context, timeBetweenCheckinsLng: Long) {
