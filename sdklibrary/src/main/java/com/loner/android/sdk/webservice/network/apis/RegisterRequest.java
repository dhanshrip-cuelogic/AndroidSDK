...
public class RegisterRequest extends BaseRequest {
    ...
    public void register(final BaseRequest requestObject) {
//        String payload = JsonFactory.getInstance().toJson(accountMapRequestData);
//        Logger.vLog(TAG, payload);
        ...
        callRegistration.enqueue(new Callback<AccessToken>() {
            ...
            public void onResponse(Call<AccessToken> call, Response<AccessToken> response) {
                if (response.code() == 200) {
                    ...
                    listener.onSuccess(requestObject, accessToken);
                } else {
